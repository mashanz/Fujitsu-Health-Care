...
#=====================================================================
def f0_knowladge_check(coordinat,fuzzy_value_a,fuzzy_value_b,output):
 ...
 if (fuzzy_value_a[coordinat[0]]>0 and fuzzy_value_b[coordinat[1]]>0):
  ...
  output.extend([[knowladge_F0[coordinat[0]][coordinat[1]],out]])
  #print(output)
...
def f0_centroid(resolution,f_out,output):
 #print(f_out,output)
 i=resolution
 s1=0
 s2=0
...
#=====================================================================
# F0 working as OVERWEIGH DETECTION
#=====================================================================
def f0_function(resolution,a,b,c,in_a,in_b,in_c,out,f0):
#=====================================================================
# INPUT AGE FUZZY
#=====================================================================
 i=0
...
#=====================================================================
 ...
 print("HEIGH    :",type_0(b,in_b)) # read and calculate fuzzy value
 print("WEIGH    :",type_0(c,in_c)) # read and calculate fuzzy value
 f0_out_ab(type_0(a,in_a),type_0(b,in_b),z0)
 #print("ALL      :",z0)
 print("MOST     :",counterMAX(z0,z1))
 #print("CENTROID :",f0_centroid(resolution,out,z1))
 f0_out = f0_centroid(resolution,out,z1)
 global f0_out
 f0=result(counterMAX(z0,z1),f0_centroid(resolution,out,z1))
 print("\n",f0)
#=====================================================================
...
#=====================================================================
 ...
 #plt.axvline(f0_centroid(resolution,out,z1), color='black')
