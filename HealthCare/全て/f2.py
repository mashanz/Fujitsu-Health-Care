...
#=====================================================================
def f2_knowladge_check(coordinat,fuzzy_value_a,fuzzy_value_b,output):
 ...
 if (fuzzy_value_a[coordinat[0]]>0 and fuzzy_value_b[coordinat[1]]>0):
  ...
  output.extend([[knowladge_F2[coordinat[0]][coordinat[1]],out]])
  #print(output)
...
def f2_centroid(resolution,f_out,output):
 #print(f_out,output)
 i=resolution
 s1=0
 s2=0
...
#=====================================================================
# f2 working as OVERWEIGH DETECTION
#=====================================================================
def f2_function(resolution,a,b,in_a,in_b,out,f2):
#=====================================================================
# INPUT STAIRS FUZZY
#=====================================================================
 i=0
...
#=====================================================================
 z0=[]
 z1=[]
 print("STAIRS   :",type_0(a,in_a)) # read and calculate fuzzy value
 print("ELEVATORS:",type_0(b,in_b)) # read and calculate fuzzy value
 f2_out_ab(type_0(a,in_a),type_0(b,in_b),z0)
 #print("ALL      :",z0)
 print("MOST     :",counterMAX(z0,z1))
 #print("CENTROID :",f2_centroid(resolution,out,z1))
 f2_out = f2_centroid(resolution,out,z1)
 f2=result(counterMAX(z0,z1),f2_centroid(resolution,out,z1))
 print("\n",f2)
#=====================================================================
...
#=====================================================================
 ...
 #plt.axvline(f2_centroid(resolution,out,z1), color='black')
