...
#=====================================================================
def f5_knowladge_check(coordinat,fuzzy_value_a,fuzzy_value_b,output):
...
def f5_centroid(resolution,f_out,output):
 #print(f_out,output)
 i=resolution
 s1=0
 s2=0
...
#=====================================================================
# f5 working as OVERWEIGH DETECTION
#=====================================================================
def f5_function(resolution,a,b,in_a,in_b,out):
 print("\n Coordinats")
#=====================================================================
# INPUT AGE FUZZY
#=====================================================================
...
#=====================================================================
 ...
 print(type_0(a,in_a)) # read and calculate fuzzy value
 print("\n FUZZY VALUE FROM INPUT 2")
 print(type_0(b,in_b)) # read and calculate fuzzy value
 print("\n ALL FUZZY OUTPUT")
 print(f5_out_ab(type_0(a,in_a),type_0(b,in_b),z0))
 print(z0)
 print("\n GET THE MOST VALUE")
 #f5_knowladge_most(z0,z1)
 print("\n centroid")
 #print(f5_centroid(resolution,out,z1))
...
#=====================================================================
 ...
 #plt.axvline(f5_centroid(resolution,out,z1), color='black')
